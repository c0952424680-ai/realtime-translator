...
const APP_VERSION="V10.5",APP_BUILD="V10.5-TW22-TRADITIONAL-UI-20260811-01";
...
const App={
 ...
 translationInit(){
   ...
   const languageOptions=[
     ...
     ["th","泰文"],["vi","越南文"],["id","印尼文"],["ms","馬來文"],["tl","菲律賓文"],
     ["km","高棉文"],["lo","寮文"],["my","緬甸文"],["mn","蒙古文"],["fr","法文"],["de","德文"],
     ["es","西班牙文"],["it","義大利文"],["pt","葡萄牙文"]
   ];
 ...
 registerSW(){if("serviceWorker" in navigator)navigator.serviceWorker.register("./sw.js?v=105").catch(()=>{})}
};
