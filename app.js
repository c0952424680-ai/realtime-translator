...
const APP_VERSION="V10.6",APP_BUILD="V10.6-CORE-REFACTOR-LIVE-LINK-20260811-01";
...
const App={
 ...
 registerSW(){if("serviceWorker" in navigator)navigator.serviceWorker.register("./sw.js?v=106").catch(()=>{})}
};
window.App=App;
